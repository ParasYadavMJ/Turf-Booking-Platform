        ...
        {view === 'home' ? (
          ...
          >
            ...
            <header className="mb-16 pt-8 flex flex-col md:flex-row items-center justify-between gap-12 min-h-[50vh]">
              ...
              <div className="flex-1 w-full text-left md:pl-16 lg:pl-32">
              ...
              <div className="w-full md:w-1/2 h-[500px] relative mt-8 md:mt-0 flex-shrink-0 perspective-1000 md:-ml-12 lg:-ml-24">
                  {/* Image 1 - Football */}
                  <motion.div 
                    ...
                    className="absolute top-[10%] md:left-[0%] left-[5%] w-[45%] md:w-[176px] h-[224px] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-dark z-20"
                  >
                  ...
                  <motion.div 
                    ...
                    className="absolute top-[15%] md:left-[64%] left-[55%] w-[40%] md:w-[160px] h-[192px] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-dark z-10"
                  >
                  ...
                  <motion.div 
                    ...
                    className="absolute top-[25%] md:left-[32%] left-[30%] w-[45%] md:w-[176px] h-[224px] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-dark z-30"
                  >
